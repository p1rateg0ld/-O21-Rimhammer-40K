...
{
    public abstract class Building_WorkGiverConstructStation : Building_ConstructStation
    {
        ...
        public override Job TryGiveJob()
        {
            ...
            result = TryIssueJobPackageConstruct(pawn, true).Job;
            if (result == null)
            {
                result = TryIssueJobPackageConstruct(pawn, false).Job;
            }
            pawn.Destroy();
            Notify_ConstructGained();
            return result;
        }
...
#pragma warning disable
        public ThinkResult TryIssueJobPackageConstruct(Pawn pawn, bool emergency)
        {
