...
{
    public class HediffOrkGrowingPart : Hediff_AddedPart
    {
        ...
        public override void PostRemoved()
        {
            ...
            if (flag)
            {
                this.pawn.ReplaceHediffFromBodypart(base.Part, HediffDefOf.MissingBodyPart, OrkHediffDefOf.OrkCuredBodypart);
            }
        }
    }
}
