...
using Rimhammer40k.Necrons.CScarab;

namespace Rimhammer40k.Necrons.Buildings
{
    [StaticConstructorOnStartup]
    public class Building_ScarabObelisk : Building
    {
        #region Variables

        public ThingDef_Building_ScarabObelisk def2 = null;
        ...
        public List<CanoptekScarabDef> container;
        ...
        {
            def2 = def as ThingDef_Building_ScarabObelisk;
            if (def2 == null)
                return;
