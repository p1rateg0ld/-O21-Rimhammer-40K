...
namespace Rimhammer40k.AIRobot
{
    public class X2_AIRobot : Pawn
    {
        ...
        public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
        {
            ...
            Map oldMap = this.Map ?? this.MapHeld;
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if (rechargeStation != null && rechargeStation.Spawned && !rechargeStation.Destroyed)
            {
                ...
                {
                    icon = X2_Building_AIRobotRechargeStation.UI_ButtonForceRecharge,
                    defaultLabel = X2_Building_AIRobotRechargeStation.lbSendOwnerToRecharge.Translate(),
                    defaultDesc = X2_Building_AIRobotRechargeStation.txtSendOwnerToRecharge.Translate(),
                    hotKey = KeyBindingDefOf.Misc4,
                    activateSound = SoundDef.Named("Click"),
                    action = delegate { rechargeStation.Notify_CallBotForShutdown(); },
                    disabled = rechargeStation == null,
                    disabledReason = "Error: No recharge station assigned.",
                    groupKey = 1234567 + 0
                };
                yield return opt0;
            }
            ...
            if (DebugSettings.godMode)
            {
                ...
                opt1 = new Command_Action
                {
                    icon = null,
                    defaultLabel = "LEFT",
                    defaultDesc = "Go 5 cells left",
                    hotKey = KeyBindingDefOf.Misc5,
                    activateSound = null,// SoundDef.Named("Click");
                    action = delegate { Debug_ForceGotoDistance(-5, 0); },
                    disabled = false,
                    disabledReason = "",
                    groupKey = 1234567 + 1
                };
                ...
                opt2 = new Command_Action
                {
                    icon = null,
                    defaultLabel = "DOWN",
                    defaultDesc = "Go 5 cells down",
                    hotKey = KeyBindingDefOf.Misc8,
                    activateSound = null,// SoundDef.Named("Click");
                    action = delegate { Debug_ForceGotoDistance(0, -5); },
                    disabled = false,
                    disabledReason = "",
                    groupKey = 1234567 + 2
                };
